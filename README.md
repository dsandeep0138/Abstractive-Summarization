...
<table class="tg">
  <tr>
    <th class="tg-0pky">Models-Abs</th>
    <th class="tg-0pky">ROUGE-1</th>
    <th class="tg-0pky">ROUGE-2</th>
    <th class="tg-0pky">ROUGE-L</th>
  </tr>
  <tr>
    <td class="tg-0lax">BertSumAbs12</td>
    <td class="tg-0lax">22.72</td>
    <td class="tg-0lax">7.86</td>
    <td class="tg-0lax">21.33</td>
  </tr>
  <tr>
    <td class="tg-0lax">BertAbsWeightShared</td>
